...
class CaptureManager(object):
    ...
    def __init__(self,capture,previewWindowManager=None,shouldMirrorPreview=False,white=False,options=None):
...
class Cameo:
    ...
    def __init__(self,data1=False,data2=None):

        self.data1 =data1
        self.data2 =data2

        self._windowManager = WindowManager('Cameo',self.onKeypress)
        self._captureManager = CaptureManager(cv2.VideoCapture(0),self._windowManager,True,data1,data2)
